...
void analyse(PseqList &L)
{
    ...
    for (int i = 0; i < 8; i++)
    {
        cout << i + 1 << " " << termCredit[i] << " " << fixed << setprecision(0) << termTime[i] << endl;
    }

    cout << "统计信息2：" << endl;
    cout << "BJ " << typeCredit[0] << " " << fixed << setprecision(0) << typeTime[0] << endl;
    cout << "BS " << typeCredit[1] << " " << fixed << setprecision(0) << typeTime[1] << endl;
    cout << "BT " << typeCredit[2] << " " << fixed << setprecision(0) << typeTime[2] << endl;
}
